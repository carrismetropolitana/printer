...
module.exports = async (request, reply) => {
  ...
  await QUEUEDB.Job.updateOne({ _id: QUEUEDB.toObjectId(request.params.id) }, { $set: { download_count: foundRequestedJob.download_count++, date_downloaded: [...foundRequestedJob.date_downloaded, new Date().toISOString()] } });
